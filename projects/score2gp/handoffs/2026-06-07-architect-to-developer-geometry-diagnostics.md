...
- **Product Repository**: `score2gp` (active branch: `feature/pdf-staff-tab-timing-alignment-model-v0.1`)
- **Governance Repository**: `score2gp-agentops` (active branch: `research/pdf-standard-staff-glyph-extraction-feasibility-v0.1`)
