...
accepted replacement modules and green real-source oracle

## Objective

Remove superseded fallbacks and run the final corpus release decision.
...
Known-bad mutations stay red; Lesson 5 and 6 produce useful GP output; first remaining mismatches and supported-input limits are explicit.
