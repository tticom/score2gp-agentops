...
- **Decision**: Score2GP will build and own a native vector-based recognition layer instead of consuming a third-party recognition object. Audiveris will be retired due to its unsuitability for modern born-digital instructional PDFs (e.g. failing on floating barlines and irregular layouts).
