...
Use `score2gp-project-director.md` as the top-level skill for unattended Antigravity runs. It coordinates the Architect, Developer, and Reviewer skills, performs continuation and blocker-pivot audits, and minimises human handoffs.
